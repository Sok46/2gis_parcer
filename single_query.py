import sys
import os
from PyQt6.QtWidgets import (QApplication, QWidget, QLabel, QPushButton,QLineEdit,QButtonGroup,QVBoxLayout,QCheckBox,QFileDialog)
...
class MainWindow(QWidget):
    ...
    def parceElement(self):
        ...
        street = find_item('css','#root > div > div > div._1sf34doj > div._1u4plm2 > div:nth-child(2) > div:nth-child(2) > div > div > div > div > div._jcreqo > div._fjltwx > div > div._3zzdxk > div > div > div > div > div._1b96w9b > div:nth-child(2) > div._t0tx82 > div._8sgdp4 > div > div:nth-child(1) > div._49kxlr > div > div:nth-child(2) > div:nth-child(1)')
        descr = find_item('class','_1p8iqzw')
        stars = find_item('css','#root > div > div > div._1sf34doj > div._1u4plm2 > div:nth-child(2) > div:nth-child(2) > div > div > div > div > div._jcreqo > div._fjltwx > div > div._3zzdxk > div > div > div > div > div._1tfwnxl > div._146hbp5 > div > div._y10azs')
        count_voices = find_item('css','#root > div > div > div._1sf34doj > div._1u4plm2 > div:nth-child(2) > div:nth-child(2) > div > div > div > div > div._jcreqo > div._fjltwx > div > div._3zzdxk > div > div > div > div > div._1tfwnxl > div._146hbp5 > div > div._jspzdm')
        ...
        if os.path.isfile(path): # ставить или не ставить headers
            head = False
        else:
            head = True
        df.to_csv(path, sep=';',
    ...
    def setUpMainWindow(self):
        ...
        main_v_box.addWidget(self.link_url)
